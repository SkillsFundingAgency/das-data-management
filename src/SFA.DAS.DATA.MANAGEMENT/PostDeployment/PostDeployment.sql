...
/* ASINTEL - 1601 - Access on underlying tables of Commitments view to Data Gov Role */
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Comt_Commitment' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Comt_Commitment TO DataGov
END

IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Comt_Apprenticeship' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Comt_Apprenticeship TO DataGov
END

IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Acc_AccountLegalEntity' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Acc_AccountLegalEntity TO DataGov
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Acc_Account' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Acc_Account TO DataGov
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Acc_LegalEntity' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Acc_LegalEntity TO DataGov
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='EI_ApprenticeshipIncentive' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.EI_ApprenticeshipIncentive TO DataGov
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='EI_Payment' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.EI_Payment TO DataGov
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='ReferenceData' AND TABLE_SCHEMA = 'dbo')
BEGIN
     GRANT SELECT ON dbo.ReferenceData TO DataGov
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Fin_Payment' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Fin_Payment TO DataGov
END
...
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='EI_ChangeOfCircumstance' AND TABLE_SCHEMA = 'AsData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.EI_ChangeOfCircumstance TO BetaUser
END
...
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='FAT2_ShortList' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.FAT2_ShortList TO BetaUser
END
...
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Assessor_OrganisationStandard' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Assessor_OrganisationStandard TO BetaUser
END

IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Assessor_Certificates' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Assessor_Certificates TO BetaUser
END

IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Assessor_CertificateLogs' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Assessor_CertificateLogs TO BetaUser
END
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Assessor_Organisations' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Assessor_Organisations TO BetaUser
END

IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='DAS_AssessorAssessmentData' AND TABLE_SCHEMA = 'ASData_PL' AND TABLE_TYPE='VIEW')
BEGIN
     GRANT SELECT ON ASData_PL.DAS_AssessorAssessmentData TO BetaUser
END


IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='PFBE_EmployerFeedback' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
...
/* One Time Update on Marketo Tracking Fields */


IF (GETDATE() between '2021-04-26' and '2021-04-30')
begin
  UPDATE MP
     SET MP.CampaignName=TrackingColumns.CampaignName
	    ,MP.CampaignDate=TrackingColumns.CampaignDate
		,MP.CampaignWeekName=TrackingColumns.CampaignWeekName
		,MP.TargetAudience=TrackingColumns.TargetAudience
		,MP.CampaignCategory=TrackingColumns.CampaignCategory
	FROM ASData_PL.MarketoPrograms MP
    JOIN (SELECT ProgramId
              ,case when ProgramName Like 'MA%' THEN CASE WHEN P2.Pos2=0 or P1.Pos1=0 or P3.Pos3=0 THEN '' ELSE SUBSTRING(substring(ProgramName, P2.Pos2 + 1, P3.Pos3 - P2.Pos2 - 1),1,4)+'-'+ SUBSTRING(substring(ProgramName, P2.Pos2 + 1, P3.Pos3 - P2.Pos2 - 1),5,2)+'-'+ SUBSTRING(substring(ProgramName, P2.Pos2 + 1, P3.Pos3 - P2.Pos2 - 1),7,2) END ELSE '' END as CampaignDate
              ,case when ProgramName like 'MA%' THEN CASE WHEN P3.Pos3=0 or P4.Pos4=0 THEN '' ELSE substring(ProgramName, P3.Pos3 + 1, P4.Pos4 - P3.Pos3 - 1) END ELSE '' END as CampaignName
              ,CASE WHEN ProgramName like 'MA%' THEN case WHEN P4.Pos4=0 or P5.Pos5=0 THEN '' ELSE substring(ProgramName, P4.Pos4 + 1, P5.Pos5 - P4.Pos4 - 1) END ELSE '' END as CampaignCategory
		      ,CASE WHEN ProgramName like 'MA%' THEN case WHEN P5.Pos5=0 and P6.Pos6=0 THEN ''
			                                              WHEN P5.Pos5<>0 and P6.Pos6=0 and substring(ProgramName, P5.Pos5 + 1, len(ProgramName)) like 'Week%' THEN substring(ProgramName, P5.Pos5 + 1, len(ProgramName))
														  WHEN P5.Pos5<>0 and P6.Pos6<>0 THEN	substring(ProgramName, P5.Pos5 + 1, P6.Pos6 - P5.Pos5 - 1)													 
														  ELSE ''
												      END 
					ELSE '' 
					 END as CampaignWeekName
		      ,CASE WHEN ProgramName like 'MA%' THEN case when P6.Pos6=0 and substring(ProgramName, P5.Pos5 + 1, len(ProgramName)) not like 'Week%' THEN substring(ProgramName, P5.Pos5 + 1, len(ProgramName)) 
			                                              when P6.Pos6=0 and substring(ProgramName, P5.Pos5 + 1, len(ProgramName)) like 'Week%' THEN ''
														  when P6.Pos6<>0 THEN substring(ProgramName, P6.Pos6 + 1, len(ProgramName)) 
														  ELSE '' 
													  end
					ELSE ''
				     END as TargetAudience
         FROM ASData_PL.MarketoPrograms
  cross apply (select (charindex('_', ProgramName))) as P1(Pos1)
  cross apply (select (charindex('_', ProgramName, P1.Pos1+1))) as P2(Pos2)
  cross apply (select (charindex('_', ProgramName, P2.Pos2+1))) as P3(Pos3)
  cross apply (select (charindex('_', ProgramName, P3.Pos3+1))) as P4(Pos4)
  cross apply (select (charindex('_', ProgramName, P4.Pos4+1))) as P5(Pos5)
  cross apply (select (charindex('_', ProgramName, P5.Pos5+1))) as P6(Pos6) ) TrackingColumns
     ON MP.ProgramId=TrackingColumns.ProgramId
end