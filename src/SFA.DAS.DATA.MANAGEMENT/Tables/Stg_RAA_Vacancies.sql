...
(
 ...
 ,ApplicationIstructions VARCHAR(256)
 ,ApplicationMethod VARCHAR(256)
 ...
 ,QualificationType VARCHAR(256)
 ,QualificationSubject VARCHAR(256)
 ,QualificationGrade VARCHAR(256)
 ,QualificationWeighting VARCHAR(256)
 ,ShortDescription VARCHAR(max)
 ,Skills VARCHAR(max)
 ,StartDateTimeStamp VARCHAR(256)
 ,ThingsToConsider VARCHAR(256)
