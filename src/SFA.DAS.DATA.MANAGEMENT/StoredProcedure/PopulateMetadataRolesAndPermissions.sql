...
('BetaUser','Mtd','RP_LookupOversightReviewStatus','TABLE','SELECT',0,1),
('BetaUser','Mtd','RP_LookupPageTitles','TABLE','SELECT',0,1),
('BetaUser','Mtd','RP_LookupQuestionTitles','TABLE','SELECT',0,1),
('BetaUser','Mtd','RP_LookupSectionTitles','TABLE','SELECT',0,1),
('BetaUser','Mtd','RP_LookupSequenceTitles','TABLE','SELECT',0,1),
