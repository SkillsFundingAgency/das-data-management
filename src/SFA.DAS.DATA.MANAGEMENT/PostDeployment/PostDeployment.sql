...
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.VIEWS where TABLE_NAME='Acc_Account' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
     GRANT SELECT ON ASData_PL.Acc_Account TO BetaUser
END

IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.VIEWS where TABLE_NAME='Resv_Reservation' AND TABLE_SCHEMA = 'ASData_PL')
BEGIN
