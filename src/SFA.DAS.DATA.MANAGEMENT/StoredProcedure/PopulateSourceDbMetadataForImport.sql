...
/* Accounts and Users */
VALUES
 ('Users','User','dbo','[Id],[IsActive],[FailedLoginAttempts],[IsLocked],[IsSuspended],[GovUkIdentifier],[LastSuspendedDate]','[Password],[Salt],[PasswordProfileId],[Email]','[FirstName],[LastName]','EAU_User',0)
