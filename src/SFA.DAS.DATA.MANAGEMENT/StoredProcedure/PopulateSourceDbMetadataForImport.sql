...
('Roatp','Organisations','dbo','[Id], [CreatedAt], [UpdatedAt], [StatusId], [ProviderTypeId],[OrganisationTypeId], [UKPRN],[LegalName],[TradingName],[OrganisationData],[StatusDate], CompanyNumber','[CreatedBy],[UpdatedBy]','','0',1
	,'SELECT [Id], [CreatedAt], [UpdatedAt], [StatusId], [ProviderTypeId],[OrganisationTypeId], [UKPRN],[LegalName],[TradingName],NULL as [OrganisationData],[StatusDate],  CompanyNumber FROM dbo.Organisations'
...
VALUES
    ...
    ('Appsi','Review','dbo','[Id],[AppId],[VendorId],[ExternalId],[ReviewerName],[Rating],[Title],[Comment],[ReviewDate],[DeviceInfo],[IsNegative],[ZendeskTicketId],[CreatedAt],[ProcessedAt],[UpdatedAt]','','',0,1,'SELECT [Id],[AppId],[VendorId],[ExternalId],[ReviewerName],[Rating],[Title],[Comment],[ReviewDate],[DeviceInfo],[IsNegative],[ZendeskTicketId],[CreatedAt],[ProcessedAt],[UpdatedAt] FROM [dbo].[Review]','Appsi_Review')
