...
(
		Select MLData.LeadId,MLData.[FirstName],MLData.[LastName],MLData.[EmailAddress],MLData.[Unsubscribed],MLData.[UnsubscribedFeedback],MLData.[UnsubscribedFeedbackVerbatim],MLData.[LeadCreatedAt],MLData.[LeadUpdatedAt],trim(STRING_AGG(EmpData.EmployerHashedId,',')) As EmployerHashedId,trim(STRING_AGG(Cast(ProviderData.Ukprn As NVarchar(20)),',')) As ProviderID
		...
		Group by MLData.LeadId,MLData.[FirstName],MLData.[LastName],MLData.[EmailAddress],MLData.[Unsubscribed],MLData.[UnsubscribedFeedback],MLData.[UnsubscribedFeedbackVerbatim],MLData.[LeadCreatedAt],MLData.[LeadUpdatedAt]
) as source
...
(
        Select MLData.LeadId,MLData.[FirstName],MLData.[LastName],MLData.[EmailAddress],MLData.[Unsubscribed],MLData.[UnsubscribedFeedback],MLData.[UnsubscribedFeedbackVerbatim],MLData.[CreatedAt],MLData.[UpdatedAt],trim(STRING_AGG(EmpData.EmployerHashedId,',')) As EmployerHashedId,trim(STRING_AGG(Cast(ProviderData.Ukprn As NVarchar(20)),',')) As ProviderID
...
MERGE AsData_PL.MarketoLeads as Target
 USING baseMarketoLeadsData as Source
  ...
  THEN UPDATE SET Target.FirstName=CASE WHEN Source.FirstName='NULL' THEN NULL ELSE Source.FirstName END
				 ...
				 ,Target.UnsubscribedFeedback=CASE WHEN Source.UnsubscribedFeedback='NULL' THEN NULL ELSE Source.UnsubscribedFeedback END
				 ,Target.UnsubscribedFeedbackVerbatim=CASE WHEN Source.UnsubscribedFeedbackVerbatim='NULL' THEN NULL ELSE Source.UnsubscribedFeedbackVerbatim END
  ...
  THEN INSERT (LeadId
       ...
       VALUES (TRY_CONVERT(bigint,LeadId)
			  ...
			  ,CASE WHEN Source.UnsubscribedFeedback='NULL' THEN NULL ELSE Source.UnsubscribedFeedback END
			  ,CASE WHEN Source.UnsubscribedFeedbackVerbatim='NULL' THEN NULL ELSE Source.UnsubscribedFeedbackVerbatim END
