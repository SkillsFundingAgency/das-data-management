...
(
  Date_SK VARCHAR(8),
    ...
    Quarter_Name_Long VARCHAR(8),
    Quarter_Desc VARCHAR(5),
    Half_Year_Number_In_Year INT,
    Half_Year_Name_Short VARCHAR(2),
    Half_Year_Name_Long VARCHAR(10),
    Calendar_Year_Account VARCHAR(4),
    Financial_Year_Account VARCHAR(4),
    Academic_Year_Account VARCHAR(4),
    ...
    Financial_Quarter_Id VARCHAR(3),
