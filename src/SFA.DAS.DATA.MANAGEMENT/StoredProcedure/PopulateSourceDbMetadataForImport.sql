...
VALUES
('EmpInc','PendingPayment','archive','[PendingPaymentId],[AccountId],[ApprenticeshipIncentiveId],[DueDate],[Amount],[CalculatedDate],[PaymentMadeDate],[PeriodNumber],[PaymentYear],[AccountLegalEntityId],[EarningType],[ClawedBack],[ArchiveDateUTC]','','',0,'EI_Archive_PendingPayment','EI_Archive_PendingPayment')
