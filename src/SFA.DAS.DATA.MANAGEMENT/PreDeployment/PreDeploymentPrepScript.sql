...
TRUNCATE  TABLE [ASData_PL].[FAT_ROATPV2_Standard]
IF EXISTS (
SELECT * FROM INFORMATION_SCHEMA.COLUMNS  WHERE TABLE_SCHEMA='ASData_PL' AND TABLE_NAME='FAT_ROATPV2_Standard' AND COLUMN_NAME in ('Version','ApprenticeshipType'))
