...
('DWHLkpUser','lkp','LARSSectorSubjectAreaTier1','TABLE','SELECT',0,1),
('DWHLkpUser','lkp','LARSSectorSubjectAreaTier1','TABLE','INSERT',0,1),
('DWHLkpUser','lkp','LARSSectorSubjectAreaTier2','TABLE','ALTER',0,1),
('DWHLkpUser','lkp','LARSSectorSubjectAreaTier2','TABLE','SELECT',0,1),
('DWHLkpUser','lkp','LARSSectorSubjectAreaTier2','TABLE','INSERT',0,1),
