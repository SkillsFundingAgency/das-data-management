...
INSERT INTO Mtd.SourceConfigForImport (SourceDatabaseName,SourceTableName,SourceSchemaName,ColumnNamesToInclude,ColumnNamesToExclude,ColumnNamesToMask,FullCopyToPL,ModelDataToPL,PLTableName)
VALUES
('Roatpv2','NationalAchievementRate','dbo','[Id],[ProviderId],[Age],[SectorSubjectArea],[ApprenticeshipLevel],[OverallCohort],[OverallAchievementRate]','','',1,0,'FATROATPV2_NationalAchievementRate'),
('Roatpv2','NationalAchievementRateOverall','dbo','[Id],[Age],[SectorSubjectArea],[ApprenticeshipLevel],[OverallCohort],[OverallAchievementRate]','','',1,0,'FATROATPV2_NationalAchievementRateOverall'),
('Roatpv2','Provider','dbo',' [Id],,[TradingName],[EmployerSatisfaction],[LearnerSatisfaction],[IsImported]','[Phone],[Website],[MarketingInfo]','[Ukprn],[LegalName],[Email]',1,1,'FATROATPV2_Provider'),
('Roatpv2','ProviderCourse','dbo','[Id],[ProviderId],[LarsCode],[StandardInfoUrl],[ContactUsPageUrl],[ContactUsEmail],[ContactUsPhoneNumber],[IsApprovedByRegulator],[IsImported],[HasPortableFlexiJobOption]','','',1,0,'FATROATPV2_ProviderCourse'),
('Roatpv2','ProviderCourseLocation','dbo','[Id],[NavigationId],[ProviderCourseId],[ProviderLocationId],[HasDayReleaseDeliveryOption],[HasBlockReleaseDeliveryOption],[IsImported]','','',1,0,'FATROATPV2_ProviderCourseLocation'),
('Roatpv2','ProviderLocation','dbo','[Id],[ImportedLocationId],[NavigationId],[ProviderId],[RegionId],[Postcode],[Latitude],[Longitude],[IsImported],[LocationType]','[Phone],[AddressLine1],[AddressLine2],[Town],[County]','[LocationName],[Email],[Website]',1,0,'FATROATPV2_ProviderLocation'),
('Roatpv2','ProviderRegistrationDetail','dbo','[LegalName],[StatusId],[StatusDate],[OrganisationTypeId],[ProviderTypeId]','','[Ukprn]',1,0,'FATROATPV2_ProviderRegistrationDetail'),
('Roatpv2','ProviderAddress','dbo','[Id],[ProviderId],[Postcode],[Latitude],[Longitude],[AddressUpdateDate],[CoordinatesUpdateDate]','[AddressLine1],[AddressLine2],[AddressLine3],[AddressLine4],[Town]','',1,0,'FATROATPV2_ProviderAddress'),
('Roatpv2','Standard','dbo','[StandardUId],[LarsCode],[IfateReferenceNumber],[Level],[Version],[SectorSubjectArea]','[ApprovalBody]','[Title]',1,0,'FATROATPV2_Standard')
