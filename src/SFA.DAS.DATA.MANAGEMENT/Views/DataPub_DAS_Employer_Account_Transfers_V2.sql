...
AS 
SELECT
      CAST(ISNULL(AT.Id ,-1)  AS bigint)                                              As TransferId
    ...
    , CAST(ISNULL(at.eventid,'00000000-0000-0000-0000-000000000000')  as uniqueidentifier)                      As RequiredPaymentId
    , CAST(ISNULL(ApprenticeshipId ,-1) AS bigint)                                          As CommitmentId
    , CAST(at.Amount  as decimal(18,5))                                                As Amount
    , CAST('Levy' as nvarchar(50))                                                          As Type
    , CAST(ISNULL(at.PeriodEnd ,'XXXX') AS NVARCHAR(10))                                    As CollectionPeriodName
    , CAST(ISNULL(at.eventtime,'9999-12-31')  as datetime)                             As UpdateDateTime
