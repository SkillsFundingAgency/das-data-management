...
begin
  UPDATE MP
    ...
    JOIN (SELECT ProgramId
		      ...
		      ,CASE WHEN ProgramName like 'MA%' THEN case when P5.Pos5=0 or P6.Pos6=0 THEN '' ELSE substring(ProgramName, P5.Pos5 + 1, P6.Pos6 - P5.Pos5 - 1) END ELSE '' END as CampaignWeekName
		      ,CASE WHEN ProgramName like 'MA%' THEN case when P6.Pos6=0 THEN '' ELSE substring(ProgramName, P6.Pos6 + 1, len(ProgramName)) END ELSE '' END as TargetAudience
