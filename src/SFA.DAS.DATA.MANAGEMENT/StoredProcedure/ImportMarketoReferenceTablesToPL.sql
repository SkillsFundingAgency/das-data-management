...
/* Delta Update MarketoPrograms */
 ...
 USING (SELECT *
 ,CASE WHEN (Name Like 'MA%' OR updatedAt >= '2022-10-13') THEN CASE WHEN P2.Pos2=0 or P1.Pos1=0 or P3.Pos3=0 THEN '' ELSE CASE WHEN LEN(substring(Name, P2.Pos2 + 1, P3.Pos3 - P2.Pos2 - 1)) = 6 OR LEN(substring(Name, P2.Pos2 + 1, P3.Pos3 - P2.Pos2 - 1)) =8 THEN CAST(ISNULL(TRY_CAST(CAST(substring(Name, P2.Pos2 + 1, P3.Pos3 - P2.Pos2 - 1) as char(8)) as date),'')as varchar(20)) ELSE '' END END ELSE '' END as CampaignDate
