...
VALUES
 ...
 ,('Assessor','Standards','dbo','[StandardUId],[Title],[Version],[Level],[Status],[TypicalDuration],[MaxFunding],[IsActive],[LastDateStarts],[EffectiveFrom],[EffectiveTo],[VersionEarliestStartDate],[VersionLatestStartDate],[VersionLatestEndDate],[VersionApprovedForDelivery],[ProposedTypicalDuration],[ProposedMaxFunding]','','[IFateReferenceNumber],[LarsCode]',1,1,
    ...
    'Assessor_Standards')
,('Assessor','Apply','dbo','[Id],[ApplicationId],[OrganisationId],[ApplicationStatus],[ReviewStatus],[FinancialReviewStatus],[FinancialDueDate],[StandardCode],[CreatedAt],[UpdatedAt],[DeletedAt],[ApplicationType],[StandardReference]','','[SelectedGrade],[GradedBy],[CreatedBy]',0,1,
    'select [Id],[ApplicationId],[OrganisationId],[ApplicationStatus],[ReviewStatus],[FinancialReviewStatus],[SelectedGrade],[FinancialDueDate],[GradedBy],[StandardCode],[CreatedAt],[CreatedBy],[UpdatedAt],[DeletedAt],[ApplicationType],[StandardReference]FROM(Select [Id],[ApplicationId],[OrganisationId],[ApplicationStatus],[ReviewStatus],[FinancialReviewStatus],JSON_VALUE([FinancialGrade],''''$.SelectedGrade'''') SelectedGrade,JSON_VALUE([FinancialGrade],''''$.FinancialDueDate'''') FinancialDueDate,JSON_VALUE([FinancialGrade],''''$.GradedBy'''') GradedBy,[StandardCode],[CreatedAt],[CreatedBy],[UpdatedAt],[DeletedAt],[ApplicationType],[StandardReference]  from [dbo].[Apply] ) As a ',
    'Assessor_Apply')
