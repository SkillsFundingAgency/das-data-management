...
VALUES
('CRSDelivery','NationalAchievementRate','dbo','[Id],[Age],[SectorSubjectArea],[ApprenticeshipLevel],[OverallCohort],[OverallAchievementRate]','','[UkPrn]',1,0,'CRSDel_NationalAchievementRate'),
...
('CRSDelivery','Provider','dbo','[Id],[TradingName],[EmployerSatisfaction],[LearnerSatisfaction]','[Phone],[Website]','[UkPrn],[Name],[Email]',1,1,'CRSDel_Provider'),
...
('CRSDelivery','StandardLocation','dbo','[LocationId],[Postcode],[Lat],[Long]','[Phone],[Address1],[Address2],[Town],[County]','[Name],[Email],[Website]',1,0,'CRSDel_StandardLocation')
...
('CRS','Framework','dbo','[Id],[ProgType],[FrameworkCode],[PathwayCode],[Level],[TypicalLengthFrom],[TypicalLengthTo],[TypicalLengthUnit],[Duration],[CurrentFundingCap],[MaxFunding],[Ssa1],[Ssa2],[EffectiveFrom],[EffectiveTo],[IsActiveFramework],[ProgrammeType],[HasSubGroups],[ExtendedTitle]','','[Title],[FrameworkName],[PathwayName]',1,1,'CRS_Framework'),
...
('CRS','SectorSubjectAreaTier2','dbo','[SectorSubjectAreaTier2],[SectorSubjectAreaTier2Desc],[EffectiveFrom],[EffectiveTo]','','[Name]',1,0,'CRS_SectorSubjectAreaTier2'),
('CRS','Standard','dbo','[Id],[Level],[IntegratedDegree],[OverviewOfRole],[RouteId],[Keywords],[TypicalJobTitles],[StandardPageUrl],[Version],[RegulatedBody],[Skills],[Knowledge],[Behaviours],[Duties],[CoreAndOptions]','','[Title]',1,1,'CRS_Standard')
