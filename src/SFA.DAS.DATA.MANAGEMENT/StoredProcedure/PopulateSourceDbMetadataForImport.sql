...
,('Apply','FinancialReview','dbo','[Id],[ApplicationId],[Status],[SelectedGrade],[FinancialDueDate],[GradedOn],[ClarificationRequestedOn],[ClarificationResponse]',''
		...
		,'RP_FinancialReview')
,('Apply','OrganisationAddresses','NA','[ID],[OrganisationId],[AddressType],[AddressLine1],[AddressLine2],[AddressLine3],[City],[Postcode]','','',0,1,'SELECT Id,OrganisationId,AddressType,AddressLine1,AddressLine2,AddressLine3,City,Postcode FROM dbo.OrganisationAddresses','RP_OrganisationAddresses')
