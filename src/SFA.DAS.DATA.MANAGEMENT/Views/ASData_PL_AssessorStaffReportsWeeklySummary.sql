CREATE VIEW [ASData_PL].[AssessorStaffReportsWeeklySummary]
As
		
   with cte_WeeklySummary as (
	SELECT 
	...
	[FirstSubmitOrPrintedPassEvent] JOIN [ASData_PL].[Assessor_Certificates] [Certificates] 
