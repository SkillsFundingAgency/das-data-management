...
('Developer','Mtd','','',1,1),
('Developer','Comp','','',1,1),
('Developer','dbo','DASCalendarMonth','VIEW',0,1),
('Developer','dbo','ReferenceData','TABLE',0,1),
('Developer','dbo','SourceDbChanges','TABLE',0,1),
('Developer','dbo','DataDictionary','VIEW',0,1),
/* BetaUser */
