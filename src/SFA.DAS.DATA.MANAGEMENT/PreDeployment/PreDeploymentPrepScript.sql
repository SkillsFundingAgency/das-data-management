...
DROP TABLE IF EXISTS [ASDATA_PL].[FAT_ROATP_Organisations]
DROP TABLE IF EXISTS [ASDATA_PL].[FAT_ROATP_OrganisationStatus]
DROP TABLE IF EXISTS [ASDATA_PL].[FAT_ROATP_ProviderTypes]
