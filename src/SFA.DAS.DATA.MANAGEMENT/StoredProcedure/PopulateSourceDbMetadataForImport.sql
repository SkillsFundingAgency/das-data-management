...
INSERT INTO Mtd.SourceConfigForImport (SourceDatabaseName,SourceTableName,SourceSchemaName,ColumnNamesToInclude,ColumnNamesToExclude,ColumnNamesToMask,FullCopyToPL,ModelDataToPL,PLTableName)
VALUES
('Roatp','Organisations','dbo','[Id], [CreatedAt], [UpdatedAt], [StatusId], [ProviderTypeId],[OrganisationTypeId], [UKPRN],[LegalName],[TradingName]','[CreatedBy],[UpdatedBy],[StatusDate],[OrganisationData]','',1,0,'FAT_ROATP_Organisations'),
...
('Pfbe','ProviderAttributeSummary','dbo','[AttributeId], [Strength], [Weakness], [TimePeriod], [UpdatedOn]','','[Ukprn]','Pfbe_ProviderAttributeSummary','Pfbe_ProviderAttributeSummary',0,1,'SELECT   [Ukprn], [AttributeId], [Strength], [Weakness], [TimePeriod], [UpdatedOn] from Pfbe_ProviderAttributeSummary' ),
('Pfbe','ProviderRatingSummary','dbo','[Ukprn], [Rating], [RatingCount], [TimePeriod], [UpdatedOn]','','[Ukprn]','Pfbe_ProviderRatingSummary','Pfbe_ProviderRatingSummary',0,1,'SELECT  [Ukprn], [Rating], [RatingCount], [TimePeriod], [UpdatedOn] from Pfbe_ProviderRatingSummary'),
