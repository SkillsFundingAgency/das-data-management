...
('DataGov','sys','databases','TABLE','SELECT',0,1),
('DataGov','sys','database_principals','TABLE','SELECT',0,1),
('DataGov','sys','extended_properties','TABLE','SELECT',0,1),
('DataGov','sys','objects','TABLE','SELECT',0,1),
('DataGov','sys','types','TABLE','SELECT',0,1),
('DataGov','sys','columns','TABLE','SELECT',0,1),
('DataGov','sys','default_constraints','TABLE','SELECT',0,1),
('DataGov','sys','identity_columns','TABLE','SELECT',0,1),
('DataGov','sys','index_columns','TABLE','SELECT',0,1),
('DataGov','sys','key_constraints','TABLE','SELECT',0,1),
('DataGov','sys','foreign_key_columns','TABLE','SELECT',0,1),
('DataGov','sys','triggers','TABLE','SELECT',0,1),
('DataGov','sys','trigger_events','TABLE','SELECT',0,1),
('DataGov','sys','parameters','TABLE','SELECT',0,1),
('DataGov','sys','synonyms','TABLE','SELECT',0,1),
('DataGov','sys','sql_modules','TABLE','SELECT',0,1),
('DataGov','sys','all_objects','TABLE','SELECT',0,1),
('DataGov','sys','sequences','TABLE','SELECT',0,1),
('DataGov','sys','sql_expression_dependencies','TABLE','SELECT',0,1),
/* Finance */
