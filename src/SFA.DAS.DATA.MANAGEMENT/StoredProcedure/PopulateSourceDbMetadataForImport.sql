...
(SourceDatabaseName,SourceTableName,SourceSchemaName,ColumnNamesToInclude,ColumnNamesToExclude,ColumnNamesToMask,[ModelDataToPL])
VALUES
 ('EmpInc','Accounts','dbo','[Id],[AccountLegalEntityId],[LegalEntityId],[HashedLegalEntityId],[HasSignedIncentivesTerms],[SignedAgreementVersion],[VrfVendorId],[VrfCaseId],[VrfCaseStatus],[VrfCaseStatusLastUpdatedDateTime]','[LegalEntityName]','',1)
