...
,('Commitments','OverlappingTrainingDateRequest','dbo','[Id],[DraftApprenticeshipId],[PreviousApprenticeshipId],[ResolutionType],[Status],[CreatedOn],[ActionedOn],[NotifiedServiceDeskOn]','[RequestCreatedByProviderEmail],[RowVersion],[NotifiedEmployerOn]','','Comt_OverlappingTrainingDateRequest',0)
