...
,('EmpInc','PendingPaymentValidationResult','incentives','SELECT [Id],[PendingPaymentId],[Step],[Result],[PeriodNumber],[PaymentYear],[CreatedDateUTC],[OverrideResult] FROM [incentives].[PendingPaymentValidationResult]','CreatedDateUTC','1900-01-01','EI_PendingPaymentValidationResult',Getdate(),'ImportEI_PendingPaymentValidationResultToPL')
UPDATE tgt
    SET 
