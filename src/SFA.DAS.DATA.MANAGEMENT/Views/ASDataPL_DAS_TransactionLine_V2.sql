 ...
 AS 
 		with saltkeydata as 
		(
			Select TOP 1 SaltKeyID,SaltKey From AsData_PL.SaltKeyLog Where SourceType ='TransactionLine'  Order by SaltKeyID DESC 
		)
		SELECT 
					[Id], 
					[AccountId],  
					...
					'Suppressed' As [TransferSenderAccountName],  
					[TransferReceiverAccountId],  
					'Suppressed' As [TransferReceiverAccountName]  
