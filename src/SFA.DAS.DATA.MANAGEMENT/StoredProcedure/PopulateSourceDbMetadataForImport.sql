...
(SourceDatabaseName,SourceTableName,SourceSchemaName,ColumnNamesToInclude,ColumnNamesToExclude,ColumnNamesToMask,ModelDataToPL,IsQueryBasedImport,SourceQuery,StagingTableName)
VALUES
   ('Assessor','Certificates','dbo','[Id],[LearnerGivenNames],[LearnerFamilyName],[StandardName],[StandardLevel],[StandardPublicationDate],[ContactName],[ContactOrganisation],[ContactPostCode],[LearningStartDate],[AchievementDate],[CourseOption],[OverallGrade],[Department],[FullName],[ToBePrinted],[CreatedAt],[DeletedAt],[OrganisationId],[BatchNumber],[Status],[UpdatedAt],[StandardCode],[IsPrivatelyFunded],[PrivatelyFundedStatus],[StandardUId]','[Uln],[ContactAddLine1],[ContactAddLine2],[ContactAddLine3],[ContactAddLine4],[LearnRefNumber]','[Registration],[ProviderName],[StandardReference],[CreatedBy],[UpdatedBy],[DeletedBy],[CertificateReference],[ProviderUkPrn],[CertificateReferenceId],[CreateDay]',0,1
  ...
  ,('Assessor','OrganisationStandard','dbo','[Id],[EndPointAssessorOrganisationId],[StandardCode],[EffectiveFrom],[EffectiveTo],[DateStandardApprovedOnRegister],[Comments],[Status],[ContactId],[DeliveryAreaComments],[StandardReference]','','',0,1
      ,'select [Id],[EndPointAssessorOrganisationId],[StandardCode],[EffectiveFrom],[EffectiveTo],[DateStandardApprovedOnRegister],[Comments],[Status],[ContactId],json_value([OrganisationStandardData],''$.DeliveryAreaComments'') As DeliveryAreaComments,[StandardReference] from [dbo].[OrganisationStandard]'
