...
(SourceDatabaseName,SourceTableName,SourceSchemaName,ColumnNamesToInclude,ColumnNamesToExclude,ColumnNamesToMask,ModelDataToPL,IsQueryBasedImport,SourceQuery,StagingTableName)
VALUES
   ('Assessor','Certificates','dbo','[Id],[StandardName],[StandardLevel],[StandardPublicationDate],[ContactOrganisation],[ContactPostCode],[LearningStartDate],[AchievementDate],[CourseOption],[OverallGrade],[Department],[ToBePrinted],[CreatedAt],[DeletedAt],[OrganisationId],[BatchNumber],[Status],[UpdatedAt],[StandardCode],[IsPrivatelyFunded],[PrivatelyFundedStatus],[StandardUId]','[Uln],[ContactAddLine1],[ContactAddLine2],[ContactAddLine3],[ContactAddLine4],[LearnRefNumber],[FullName],[LearnerGivenNames],[LearnerFamilyName],[ContactName]','[Registration],[ProviderName],[StandardReference],[CertificateReference],[ProviderUkPrn],[CertificateReferenceId],[CreateDay]',0,1
