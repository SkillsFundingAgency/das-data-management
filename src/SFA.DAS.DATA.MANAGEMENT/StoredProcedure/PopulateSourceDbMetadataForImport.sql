...
VALUES
  ...
  ,('Assessor','OrganisationStandard','dbo','[Id],[EndPointAssessorOrganisationId],[StandardCode],[EffectiveFrom],[EffectiveTo],[DateStandardApprovedOnRegister],[Status],[ContactId],[DeliveryAreaComments],[StandardReference]','','[Comments]',0,1
      ,'select [Id],[EndPointAssessorOrganisationId],[StandardCode],[EffectiveFrom],[EffectiveTo],[DateStandardApprovedOnRegister],[Comments],[Status],[ContactId],JSON_VALUE(OrganisationStandardData,''''$.DeliveryAreaComments'''') [DeliveryAreaComments],[StandardReference] from [dbo].[OrganisationStandard]'
