...
,('Commitments','Accounts','dbo','[Id],[HashedId],[Name],[Created],[Updated],[LevyStatus]','[PublicHashedId]','','Comt_Accounts',0)
...
,('Commitments','Apprenticeship','dbo','[Id],[CommitmentId],[TrainingType],[TrainingCode],[TrainingName],[Cost],[StartDate],[EndDate],[AgreementStatus],[PaymentStatus],[CreatedOn],[AgreedOn],[PaymentOrder],[StopDate],[PauseDate],[HasHadDataLockSuccess],[PendingUpdateOriginator],[EPAOrgId],[CloneOf],[ReservationId],[IsApproved],[CompletionDate],[ContinuationOfId],[MadeRedundant],[OriginalStartDate],[TrainingCourseVersion],[TrainingCourseVersionConfirmed],[TrainingCourseOption],[DeliveryModel],[RecognisePriorLearning],[IsOnFlexiPaymentPilot],[TrainingTotalHours],[ActualStartDate],[EmailAddressConfirmed],[LastUpdated],[UpdatedOn],[EmployerHasEditedCost],[EndPointAssessmentPrice],[TrainingPrice],[ULN],[StandardUId],[DateOfBirth]','[NINumber],[EmployerRef],[ProviderRef],[Email],[FirstName],[LastName]','','comt_Apprenticeship',1)
