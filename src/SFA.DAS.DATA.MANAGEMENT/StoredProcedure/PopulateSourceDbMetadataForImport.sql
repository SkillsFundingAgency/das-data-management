...
(SourceDatabaseName,SourceTableName,SourceSchemaName,ColumnNamesToInclude,ColumnNamesToExclude,ColumnNamesToMask,[ModelDataToPL])
VALUES
 ('EmpInc','Accounts','dbo','[Id],[AccountLegalEntityId],[LegalEntityId],[IsAgreementSigned],[SignedAgreementVersion],[VrfVendorId],[VrfCaseId],[VrfCaseStatus],[VrfCaseStatusLastUpdatedDateTime]','[LegalEntityName],[HashedLegalEntityId]','',1)
