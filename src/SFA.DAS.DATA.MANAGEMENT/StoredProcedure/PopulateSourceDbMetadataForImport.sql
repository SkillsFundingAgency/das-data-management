...
VALUES
 ...
 ,('Assessor','Organisations','dbo','[Id],[CreatedAt],[DeletedAt],[EndPointAssessorOrganisationId],[Status],[UpdatedAt],[OrganisationTypeId],[ApiEnabled],[ApiUser],[RecognitionNumber],[EndPointAssessorName],[EndPointAssessorUkprn]','','',0,1,
    'select [Id],[CreatedAt],[DeletedAt],[EndPointAssessorName],[EndPointAssessorOrganisationId],[EndPointAssessorUkprn],[Status],[UpdatedAt],[OrganisationTypeId],[ApiEnabled],[ApiUser],[RecognitionNumber],[EndPointAssessorName],[EndPointAssessorUkprn] From [dbo].[Organisations]',
