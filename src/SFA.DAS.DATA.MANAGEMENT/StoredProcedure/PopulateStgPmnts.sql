...
,('DASPayments','[Payments2].[ProviderAdjustmentPayments]','StgPmts','stg_ProviderAdjustmentPayments','Incremental','WHERE CONCAT(''ParamAcademicYear'',''-R'',RIGHT(''00''+''ParamCollectionPeriod'',2)) ','Ukprn,SubmissionId,SubmissionCollectionPeriod,SubmissionAcademicYear,PaymentType,PaymentTypeName,Amount,CollectionPeriodName,CollectionPeriodMonth,CollectionPeriodYear')
