...
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Va_County' AND TABLE_SCHEMA = 'AsData_PL')
BEGIN     
	 GRANT SELECT ON ASData_PL.Va_County To BetaUser
END
...
IF EXISTS(SELECT 1 from INFORMATION_SCHEMA.TABLES where TABLE_NAME='Va_LocalAuthority' AND TABLE_SCHEMA = 'AsData_PL')
BEGIN     
	 GRANT SELECT ON ASData_PL.Va_LocalAuthority To BetaUser
END
